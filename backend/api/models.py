...
class PendingSignup(models.Model):
    ...
    approved_on = models.CharField(max_length=20, null=True, blank=True)
    ...
    course_start_year = models.CharField(max_length=10, null=True, blank=True)
    course_end_year = models.CharField(max_length=10, null=True, blank=True)
    faculty_job_title = models.CharField(max_length=255, null=True, blank=True)
    faculty_institute = models.CharField(max_length=255, null=True, blank=True)
    faculty_department = models.CharField(max_length=255, null=True, blank=True)
    faculty_start_year = models.CharField(max_length=10, null=True, blank=True)
    faculty_start_month = models.CharField(max_length=10, null=True, blank=True)
    faculty_end_year = models.CharField(max_length=10, null=True, blank=True)
    faculty_end_month = models.CharField(max_length=10, null=True, blank=True)
    office_phone_no = models.CharField(max_length=30, null=True, blank=True)
    ...
    correspondence_city = models.CharField(max_length=255, null=True, blank=True)
    correspondence_state = models.CharField(max_length=255, null=True, blank=True)
    correspondence_country = models.CharField(max_length=255,null=True,  blank=True)
    correspondence_pincode = models.CharField(max_length=20, null=True, blank=True)
    company = models.CharField(max_length=255, null=True, blank=True)
    position = models.CharField(max_length=255, null=True, blank=True)
    member_roles = models.CharField(max_length=255, null=True, blank=True)
    educational_course = models.CharField(max_length=255, null=True, blank=True)
    educational_institute = models.CharField(max_length=255, null=True, blank=True)
    start_year = models.CharField(max_length=10, blank=True)
    end_year = models.CharField(max_length=10, blank=True)
    ...
    professional_skills = models.JSONField(default=list, null=True, blank=True)
    industries_worked_in = models.JSONField(default=list, null=True, blank=True)
    roles_played = models.JSONField(default=list, null=True, blank=True)
    ...
    passed_out_year = models.CharField(max_length=20, null=True, blank=True)
    current_work = models.CharField(max_length=255, null=True, blank=True)
    Worked_in = models.JSONField(default=list, null=True, blank=True)
